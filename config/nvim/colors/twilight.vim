...
"exe 'hi StatusLine     guifg='#000000' guibg='#000000' gui=none'
exe 'hi StatusLineNC   guifg=bg guibg=bg gui=none'
exe 'hi VertSplit      guifg='.s:darkgrey.' guibg='.s:darkgrey.' gui=none'
